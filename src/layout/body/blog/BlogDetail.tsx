                        ...
                        <div className="col-md-8 col-lg-9 p-b-80">
                            <div className="p-r-45 p-r-0-lg">
                                ...
                                <div className="wrap-pic-w how-pos5-parent">
                                    <img src="../../../../../public/assets/images/blog-04.jpg" alt="IMG-BLOG" />
                                    ...
                                    <ul>
                                        <li className="flex-w flex-t p-b-30">
                                            <a href="#" className="wrao-pic-w size-214 hov-ovelay1 m-r-20">
                                                <img src="../../../../../public/assets/images/product-min-01.jpg" alt="PRODUCT" />
                                            </a>
                                        ...
                                        <li className="flex-w flex-t p-b-30">
                                            <a href="#" className="wrao-pic-w size-214 hov-ovelay1 m-r-20">
                                                <img src="../../../../../public/assets/images/product-min-02.jpg" alt="PRODUCT" />
                                            </a>
                                            <div className="size-215 flex-col-t p-t-8">
                                                <a href="#" className="stext-116 cl8 hov-cl1 trans-04">
                                        ...
                                        <li className="flex-w flex-t p-b-30">
                                            <a href="#" className="wrao-pic-w size-214 hov-ovelay1 m-r-20">
                                                <img src="../../../../../public/assets/images/product-min-03.jpg" alt="PRODUCT" />
                                            </a>
                                            <div className="size-215 flex-col-t p-t-8">
                                                <a href="#" className="stext-116 cl8 hov-cl1 trans-04">
