                ...
                <div className="cart-wrapper cart-wide">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="quantity-control">
                                                        ...
                                                        <input type="number" className="quantity-input" onChange={(e) =>
                                                            addQuantityCart(value.productId, Number(e.target.value), value.productSizeId, value.productColorId)} defaultValue={value.quantity} />
                                                        {/* <button className="btn-increase">+</button> */}
                                                    </div>
                                                </td>
                                                <td>{formatVND(value.productPrice * value.quantity)}</td>
                                                <td style={{ cursor: 'pointer' }} onClick={(e) => deleteCartById(e, value.productId, value.productSizeId, value.productColorId)}>
                    ...
                    <div className="cart-summary">
                        ...
                        <div className='btn-feature'>
                            <button className="btn-delete-cart" onClick={(e) => deleteAllCart(e)}>Xóa toàn bộ giỏ hàng</button>
